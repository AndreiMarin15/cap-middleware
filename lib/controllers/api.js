...
function convertDiagnosis(reqBody) {
  if (
    reqBody.issueRecord.type === "medical_problem" ||
    req.body.issueRecord.type === null ||
    req.body.issueRecord.type === undefined
  ) {
    return {
      id: "finalDiagnosis",
      code: {
      ...
      valueString: reqBody.post.form_title + reqBody.post.form_diagnosis,
      resource_type: "Observation",
    };
          ...
          coding: [
            {
              ...
              display: "Sitagliptin (As Phosphate Monohydrate)",
            },
          ],
        },
      ],
...
const api = {
  ...
  addFinalDiagnosis: async (req, res) => {
    ...
    if (validApiKey !== false) {
      ...
      if (
        req.body.issueRecord.type === "medical_problem" ||
        req.body.issueRecord.type === null ||
        req.body.issueRecord.type === undefined
      ) {
