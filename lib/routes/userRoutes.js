...
const insertFull = require("../controllers/insertFull")
app.use(cors());
...
router.post("/updateRequestStatus", insertFull, testController.updateRequest);
...
router.post("/getMappings", testController.getMappingsForAPIKey);
